...
pub fn show<'a>(id: u64, token: &auth::Token, handle: &Handle)
...
pub fn retweets_of<'a>(id: u64, count: u32, token: &auth::Token, handle: &Handle)
...
pub fn lookup<'a, I: IntoIterator<Item=u64>>(ids: I, token: &auth::Token, handle: &Handle)
    -> FutureResponse<Vec<Tweet>>
{
    let mut params = HashMap::new();
...
pub fn lookup_map<'a, I: IntoIterator<Item=u64>>(ids: I, token: &auth::Token, handle: &Handle)
...
pub fn retweet<'a>(id: u64, token: &auth::Token, handle: &Handle) -> FutureResponse<Tweet> {
    let mut params = HashMap::new();
    add_param(&mut params, "tweet_mode", "extended");
...
pub fn unretweet<'a>(id: u64, token: &auth::Token, handle: &Handle) -> FutureResponse<Tweet> {
    let mut params = HashMap::new();
    add_param(&mut params, "tweet_mode", "extended");
...
pub fn like<'a>(id: u64, token: &auth::Token, handle: &Handle) -> FutureResponse<Tweet> {
    let mut params = HashMap::new();
    add_param(&mut params, "id", id.to_string());
    add_param(&mut params, "tweet_mode", "extended");
...
pub fn unlike<'a>(id: u64, token: &auth::Token, handle: &Handle) -> FutureResponse<Tweet> {
    let mut params = HashMap::new();
    add_param(&mut params, "id", id.to_string());
    add_param(&mut params, "tweet_mode", "extended");
...
///
///On success, the future returned by this function yields the given tweet.
pub fn delete<'a>(id: u64, token: &auth::Token, handle: &Handle) -> FutureResponse<Tweet> {
    let mut params = HashMap::new();
    add_param(&mut params, "tweet_mode", "extended");
